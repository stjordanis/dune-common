...
function(dune_target_link_libraries basename)
  target_link_libraries(${basename} LINK_INTERFACE_LIBRARIES ${ARGN})
  if(DUNE_BUILD_BOTH_LIBS)
    if(BUILD_SHARED_LIBS)
      target_link_libraries(${basename}-static LINK_INTERFACE_LIBRARIES ${ARGN})
    else(BUILD_SHARED_LIBS)
      target_link_libraries(${basename}-shared LINK_INTERFACE_LIBRARIES ${ARGN})
    endif(BUILD_SHARED_LIBS)
  endif(DUNE_BUILD_BOTH_LIBS)
